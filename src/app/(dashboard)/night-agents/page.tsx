...
import { useNightAgentsLocale } from './night-agents-i18n';
...
export default function NightAgentsPage() {
  ...
  const metrics = useMemo<StripMetric[]>(() => {
    ...
    return [
      ...
      { label: t.activeRuns, value: activeRuns },
      { label: t.trackedProjects, value: trackedProjects },
      { label: t.lastRun, value: formatRelative(lastRun) },
    ];
  }, [defs, runs, projects, t]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        {activeRuns > 0 && (
          <MnBadge tone="info">{activeRuns} {t.running}</MnBadge>
        )}
      </div>
