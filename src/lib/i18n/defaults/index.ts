...
import { shellDefaults, headerDefaults, searchComboboxDefaults, sidebarDefaults, aiChatPanelDefaults, notificationBellDefaults } from "./shell";
...
import { activeMissionsDefaults, agentTraceDefaults, approvalChainDefaults, augmentedBrainDefaults, augmentedBrainV2Defaults, chatDefaults, hubSpokeDefaults, neuralNodesDefaults, processTimelineDefaults } from "./agentic";
...
export const DEFAULT_MESSAGES: LocaleMessages = {
  ...
  aiChatPanel: aiChatPanelDefaults,
  notificationBell: notificationBellDefaults,
